...
import CardOfCampaign from "./CardOfCampaign";
                ...
                fetch(`https://pet-adopt-server.onrender.com/campaign/${id}`, {
                    ...
                    .then(data => {
                        ...
                        if (data.deletedCount > 0) {
                            ...
                            const remaining = postOfCampaign.filter(borrow => borrow._id !== id);
                            setPostOfCampaign(remaining);
                        }
                    })
            }
        });
    ...
    return (
        <div>
            <section className=" w-[1200px]">
                <h2 className="text-3xl text-purple-600 font-bold text-center">Al Post: {postOfCampaign.length}</h2>
                                ...
                                <div className="overflow-hidden shadow-xl md:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200 ">
                                            {
                                                postOfCampaign.map(campaignPost => <CardOfCampaign
