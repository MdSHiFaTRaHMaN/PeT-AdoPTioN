...
const Banner = () => {
    return (
        <section className="text-gray-600 mt-7 bg-gray-100 rounded shadow-xl pb-32 body-font mx-32">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:w-3/5 ml-7 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                <div className="lg:w-3/5 md:w-1/2 w-5/6">
                    <div className="lg:w-3/5 md:w-1/2 w-5/6 ml-32 relative">
                        <div className="absolute hidden lg:block">
                            <img src={P1} alt="" className="w-72 mask mask-heart h-72 absolute -mt-32 ml-32  shadow-2xl" />
                            <img src={P2} alt="" className="w-72 h-72 mt-12 mask mask-hexagon shadow-2xl" />
                        </div>
                    </div>
                </div>
                </div>
